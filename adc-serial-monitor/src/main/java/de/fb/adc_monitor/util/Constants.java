...
public final class Constants {
    ...
    public static final int SAMPLE_BUFFER_SIZE = 16;

    public static final int NUM_GRAPH_DATA_POINTS = 1000;
    public static final int GRAPH_UPDATE_PERIOD = 10; // ms, do NOT set below 1 ms with the current implementation!!
